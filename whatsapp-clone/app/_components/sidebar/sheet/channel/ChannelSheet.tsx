...
const ChannelSheet = ({ currentUser }: ChannelSheetProps) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("/api/conversation/channel");
        ...
        <ScrollArea className="h-[520px]">
          <div className="flex flex-wrap justify-center">
            <div className="text-center w-[350px]">
              ...
              <p className="text-muted-foreground text-[1.0625rem] mb-5">
