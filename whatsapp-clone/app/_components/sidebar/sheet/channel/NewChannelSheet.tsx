import { Textarea } from "@/app/whatsapp-clone-next14-main/whatsapp-clone-next14-main/components/ui/textarea";
  ...
  const handleCreateChannel = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setChannels((prevChannel: Conversation[]) => [
          ...prevChannel,
          response.data,
        ]);
        onClose();
      ...
      >
        ...
        <div className="space-y-20">
          ...
          <Textarea
            ...
            className="w-10/12 h-24 bg-gray-100 m-auto border-0 border-b-2 border-gray-400 focus:border-primary"
            value={description}
        ...
        <Button
          ...
          className=" flex w-[133.66px] h-[38px] rounded-full m-auto mt-8 bg-primary hover:bg-secondary hover:cursor-pointer"
